...
<template>
  <div class="bg-stone-50 p-4 flex items-center">
    <textarea
      ...
      @keydown.enter.alt.prevent="addNewLine"
    />
    <div>
      <div
        class="ml-4 w-11 bg-red h-11 overflow-hidden rounded-full flex items-center justify-center cursor-pointer duration-75 select-none bg-purple-500 hover:bg-purple-600 active:bg-purple-400"
        @click="sendMsg()"
      >
