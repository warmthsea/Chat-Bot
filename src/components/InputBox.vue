<template>
  <div class="bg-stone-50 p-4 flex items-center">
    <textarea class="border w-full h-20 p-2 rounded-lg" rows="2">  It was a dark and stormy night...</textarea>
    <div>
      <div
        class="ml-4 w-11 h-11 overflow-hidden rounded-full flex items-center justify-center cursor-pointer duration-75 select-none bg-purple-400 hover:bg-purple-500 active:bg-purple-400"
      >
